...
Public Class invoice_auto78
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Auto78.invoice_auto78.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedinvoice_auto78
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invoice_auto78 = New invoice_auto78()
        rpt.Site = Me.Site
        Return rpt
    End Function
